...
app = FastAPI() # Creating a new application of FastAPI
...
async def read_category_by_category(category: str):
    books_to_return = []
    for book in BOOKS:
...
async def read_author_category_by_query(book_author: str, category: str):
    # book_author is a Path Parameter and category is a Query Parameter
    books_to_return = []
    for book in BOOKS:
